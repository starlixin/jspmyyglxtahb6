...
new CommDAO().insert(request,response,"keshixinxi",ext,true,false,""); 
...
%>
  ...
  <body >
 <form  action="keshixinxi_add.jsp?f=f&id=<%=id%>"  method="post" name="form1"  onsubmit="return checkform();">
  添加科室信息:
  <br><br>
