...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
  ...
  <% 
    ...
    String url = "yishengxinxi_list2.jsp?1=1"; 
...
if(request.getParameter("biyeyuanxiao")=="" ||request.getParameter("biyeyuanxiao")==null ){}else{sql=sql+" and biyeyuanxiao like '%"+request.getParameter("biyeyuanxiao")+"%'";}
  ...
  <tr>
    ...
    <td width="60" align="center"><a href="paibanbiao_add.jsp?id=<%=map.get("id")%>">添加排班</a>   <a href="yishengxinxidetail.jsp?id=<%=map.get("id")%>" target="_blank">详细</a> </td>
  </tr>
  	<%
  }
   %>
