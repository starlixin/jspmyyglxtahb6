...
HashMap mmm = new CommDAO().getmaps("yishengbianhao",(String)request.getSession().getAttribute("username"),"yishengxinxi"); 
%>
  <form  action="yishengxinxi_updt2.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改医生信息:
  <br><br>
  <%
