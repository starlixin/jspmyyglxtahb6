...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse">  
 ...
 <% 
    ...
    String url = "yuyueyisheng_list2.jsp?1=1"; 
    String sql =  "select * from yuyueyisheng where yonghuming='"+request.getSession().getAttribute("username")+"' ";
...
if(request.getParameter("zhuangtai")=="" ||request.getParameter("zhuangtai")==null ){}else{sql=sql+" and zhuangtai like '%"+request.getParameter("zhuangtai")+"%'";}
 ...
 <td><%=map.get("zhuangtai") %></td>
    ...
    <td width="60" align="center">
	  ...
	  <% 
if(map.get("zhuangtai").equals("已预约"))
{
%>
<a href="quhao.jsp?yuyuehao=<%=map.get("yuyuehao")%>">取号就诊</a>  <a href="yuyueyisheng_detail.jsp?id=<%=map.get("id")%>">详细</a>
<%
} 
else
{
%>
 <a href="yuyueyisheng_detail.jsp?id=<%=map.get("id")%>">详细</a>
<%
}
 %>	 </td>
  </tr>
