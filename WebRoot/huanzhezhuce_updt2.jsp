...
HashMap mmm = new CommDAO().getmaps("yonghuming",(String)request.getSession().getAttribute("username"),"huanzhezhuce"); 
%>
  <form  action="huanzhezhuce_updt2.jsp?f=f&id=<%=mmm.get("id")%>"  method="post" name="form1"  onsubmit="return checkform();">
  修改患者注册:
  <br><br>
  <%
   ...
   <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
     ...
     <tr><td>信誉分：</td><td><input name='xinyufen' type='text' id='xinyufen' value='<%= mmm.get("xinyufen")%>' style='border:solid 1px #000000; color:#666666' readonly="readonly"  />此项无法修改</td></tr>
