	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(ac.equals("login"))
		{
			...
			if(!pagerandom.equals(random)&&request.getParameter("a")!=null)
			{
				...
				if (utype.equals("用户注册")){sql1="select * from yonghuzhuce where yonghuming='"+username+"' and mima='"+password+"' and issh='是'";}
			...
			if(ac.equals("adminlogin"))
		{
			...
			if(!pagerandom.equals(random)&&request.getParameter("a")!=null)
			{
				...
				if (utype.equals("医生信息")){sql1="select * from yishengxinxi where yishengbianhao='"+username+"' and mima='"+password+"'";}
